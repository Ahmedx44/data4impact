  ...
  Widget build(BuildContext context) {
    return BlocConsumer<DataCollectCubit, DataCollectState>(
      ...
      builder: (context, state) {
        ...
        if (state.error != null && state.study == null && state.cohorts.isEmpty) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Cohort Description
                  if (cohort['description'] != null && cohort['description'].toString().isNotEmpty)
                    Text(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              state.selectedCohort?['name']?.toString() ?? 'Selected Cohort',
                              style: const TextStyle(
                                fontSize: 18,
                                fontWeight: FontWeight.w700,
                              ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Wave Description
                  if (wave['description'] != null && wave['description'].toString().isNotEmpty)
                    Text(
